                ...
                if (!btn.separator) {
                    ...
                    if (btn.onpress) {
                        $(btnDiv).click(function() {
                            //Faraj start
                            var getType = {};
                            if (!(this.onpress && getType.toString.call(this.onpress) == '[object Function]')) {
                                this.onpress = window[this.onpress];
                            }
                            //Faraj end
            ...
            if (this.grid){ 
                $('.trSelected', this).each(function(){ 
                    ...
                    $(this).find('[abbr]').each(function(){                         
                         eval("value."+$(this).attr("abbr")+"='"+$(this).find("div").html()+"'");
                    });
                    selected.push(value);
                }); 
            }
