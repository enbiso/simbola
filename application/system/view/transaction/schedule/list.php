...
$this->page_breadcrumb = array(
    ...
    sterm_get('system.transaction.schedule.list.title'));

$this->page_menu = array(     
    array(
        'title' => sterm_get('system.transaction.schedule.list.menu.create'),
...
$grid->setTitle(sterm_get('system.transaction.schedule.list.table.title'));
